...
class _ConsultantShareScreen extends State<ConsultantShareScreen> {
  ...
  void screenshot() async {
    if (qrImage != null) {
      var name = 'siraf_share_qrcode_${generateMd5(widget.consultantName + DateTime.now().microsecondsSinceEpoch.toString())}.png';
      ...
      await Share.shareXFiles(
        subject: "پروفایل مشاور ${widget.consultantName} \n املاک : ${widget.estateName}",
        [
