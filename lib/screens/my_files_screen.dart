                  ...
                  itemBuilder: (context) {
                    return [
                      MyPopupMenuItem<String>(
                        ...
                        label: "جدید ترین",
                        withSpace: true,
                        icon: !currentSortType.isFill() || currentSortType == "new" ? Icons.check_rounded : null,
                      ),
                      MyPopupMenuItem<String>(
                        value: "old",
                        label: "قدیمی ترین",
                      ...
                      MyPopupMenuItem<String>(
                        ...
                        withSpace: true,
                        icon: currentSortType == "pending" ? Icons.check_rounded : null,
                      ),
                      MyPopupMenuItem<String>(
                        value: "pendingReception",
                        label: "در انتظار پذیرش",
                        withSpace: true,
                        icon: currentSortType == "pendingReception" ? Icons.check_rounded : null,
                      ),
                      MyPopupMenuItem<String>(
                        value: "acceptReception",
                        label: "پذیرش شده",
                        withSpace: true,
                        icon: currentSortType == "acceptReception" ? Icons.check_rounded : null,
                      ),
                      MyPopupMenuItem<String>(
