...
class Themes2 {
  // static const primary = Color(0xfffdb813);
  ...
  // static const secondary = Color(0xff0278dc);
  ...
  static const text = Color(0xff101113);
  static const textGrey = Color(0xff48494b);
  static const textLight = Color(0xffffffff);
  static const icon = Color(0xff3f4042);
